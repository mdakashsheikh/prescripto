    ...
    const getAvailableSlot = async() => {
        ...
        for(let i = 0; i < 7; i++) {
            ...
            while(currentDate < endTime) {
                ...
                // Increament current time by 0 minuits
    ...
    return docInfo && (
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-gray-500 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 ms:mt-0'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-gray-500 max-w-[750px] mt-1'>{docInfo.about}</p>
                    </div>
